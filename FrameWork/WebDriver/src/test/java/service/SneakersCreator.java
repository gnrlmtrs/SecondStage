...
public class SneakersCreator {
    ...
    private static final String TESTDATA_SNEAKERS_MODEL = "testdata.sneakers.model";
    private static final String TESTDATA_SNEAKERS_NAME = "testdata.sneakers.name";
    private static final String TESTDATA_SNEAKERS_SIZE = "testdata.sneakers.size";
